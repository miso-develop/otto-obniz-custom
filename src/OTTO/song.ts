...
class Song {
	...
	paprika: Song.Score = {
		...
		melody: [
			...
			[Pitch.B4	, Length.Sixteenth],
			[Pitch.A4	, Length.Sixteenth],
			[Pitch.G4	, Length.Eighth],
			[Pitch.NONE	, Length.Eighth],
			[Pitch.A4	, Length.Eighth],
			[Pitch.B4	, Length.Eighth],
			[Pitch.A4	, Length.Eighth],
			[Pitch.G4	, Length.Eighth],
			[Pitch.FS4	, Length.Quoter],
			[Pitch.E4	, Length.Eighth],
			[Pitch.D4	, Length.Eighth],
			[Pitch.D4	, Length.Quoter],
			[Pitch.NONE	, Length.Quoter],
			
			[Pitch.E4	, Length.Quoter],
			[Pitch.D4	, Length.Eighth],
			[Pitch.E4	, Length.Eighth],
			[Pitch.G4	, Length.Eighth],
			[Pitch.FS4	, Length.Eighth],
			[Pitch.E4	, Length.Eighth],
			[Pitch.E4	, Length.Eighth],
			[Pitch.DS4	, Length.Quoter],
			[Pitch.CS4	, Length.Eighth],
			[Pitch.DS4	, Length.Eighth],
			[Pitch.E4	, Length.Quoter],
			...
			[Pitch.A4	, Length.Eighth],
			[Pitch.B4	, Length.Eighth],
			[Pitch.D5	, Length.Eighth],
			[Pitch.B4	, Length.Eighth],
			[Pitch.E5	, Length.Quoter],
			[Pitch.D5	, Length.Eighth],
			[Pitch.A4	, Length.Eighth],
			[Pitch.B4	, Length.Quoter],
			[Pitch.NONE	, Length.Quoter],
